...
![арх](https://github.com/user-attachments/assets/6b37807f-d700-4d9c-84fc-d69528d97e69)
...
- [x] Поддержать шардирование на уровне storage-компоненты
- [x] Поддержать реплицирование данных на уровне storage-компоненты
- [x] Поддержать реплицирование данных на уровне управляющей компоненты
